  ...
  return (
    <div>
      ...
      <div className="flex gap-2 justify-between items-center flex-col">
        ...
        <div className="w-full mt-5">
          ...
          <i className="ri-map-pin-range-line text-xl"></i>
            ...
            <div >
              ...
              <p className="text-sm -mt-1 text-gray-600">East Nada, Guruvayur Temple, Guruvayur</p>
            </div>
          </div>
          <div className="flex items-center gap-5 p-5 border-b">
            ...
            <div className="">
              ...
              <p className="text-sm -mt-1 text-gray-600">Kottapadi Center, Guruvayur</p>
            </div>
          </div>
        ...
        <button className="w-full mt-5 bg-black text-white font-semibold p-2 rounded-lg">
          Confirm
        </button>
      </div>
    </div>
